"""Test the effect of unanticipated classes in Mean-Teacher on mnist.
...
def main():
    ...
    parser.add_argument('--labeled-batch-size', type=int, default=25, metavar='N',
    ...
    parser.add_argument('--ema-decay', type=float, default=0.999, metavar='DECAY',
    ...
    parser.add_argument('--rampup-period', type=int, default=50, metavar='N',
    ...
    folder = os.path.expanduser('./meanteacher_mnist_results')
    try:
        os.makedirs(folder)
    except OSError as e:
    ...
    for seed in range(args.runs): # seed for creating labelled and unlabelled data training data.
        ...
        if (args.save_model):
            torch.save(model.state_dict(),"meanteacher_mnist_cnn.pt")
